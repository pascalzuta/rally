...
- **Colors**: Warm neutrals (#F8F7F5 bg, #1C1C1E text), teal accent (#2B7A5F), warm shadows
- **Spacing**: 4px base unit
- **Radii**: 10-16px for cards/buttons, 999px for chips
- **Shadows**: Warm-tinted (rgba(60,50,40,...))
- **Motion**: expo/quart easing, 100-400ms durations
