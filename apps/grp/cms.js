(function () {
  ...
  const HOME_IMAGE_REPLACEMENTS = {
    ...
    "https://images.pexels.com/photos/325229/pexels-photo-325229.jpeg?auto=compress&cs=tinysrgb&w=1800":
      "https://images.pexels.com/photos/6770610/pexels-photo-6770610.jpeg?auto=compress&cs=tinysrgb&w=1800",
  ...
  const CMS_CONFIG = {
    "index.html": [
      { key: "hero_image", label: "Hero Background Image URL", type: "css-image", variable: "--hero-home-image", defaultValue: "https://images.pexels.com/photos/1295138/pexels-photo-1295138.jpeg?auto=compress&cs=tinysrgb&w=2400" },
      ...
      { key: "mission_image", label: "Mission Section Image URL", type: "image", selector: "main .section-card:nth-of-type(1) .media-slab img", defaultValue: "https://images.pexels.com/photos/6770610/pexels-photo-6770610.jpeg?auto=compress&cs=tinysrgb&w=1800" },
      ...
      { key: "sector_image_1", label: "Sector Image 1 URL", type: "image", selector: "main .section-card:nth-of-type(2) .story-stripe figure:nth-of-type(1) img", defaultValue: "https://images.pexels.com/photos/221047/pexels-photo-221047.jpeg?auto=compress&cs=tinysrgb&w=1600" },
      { key: "sector_image_2", label: "Sector Image 2 URL", type: "image", selector: "main .section-card:nth-of-type(2) .story-stripe figure:nth-of-type(2) img", defaultValue: "https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&cs=tinysrgb&w=1600" },
    ...
    "structure.html": [
      { key: "hero_image", label: "Hero Background Image URL", type: "css-image", variable: "--hero-structure-image", defaultValue: "https://images.pexels.com/photos/167698/pexels-photo-167698.jpeg?auto=compress&cs=tinysrgb&w=2400" },
      { key: "hero", label: "Hero", type: "pair", heading: ".hero h1", body: ".hero h1 + p" },
      { key: "alignment_image", label: "Alignment Section Image URL", type: "image", selector: "main .section-card:nth-of-type(1) .media-slab img", defaultValue: "https://images.pexels.com/photos/957024/forest-trees-perspective-bright-957024.jpeg?auto=compress&cs=tinysrgb&w=1800" },
    ...
    "investment-approach.html": [
      { key: "hero_image", label: "Hero Background Image URL", type: "css-image", variable: "--hero-investment-image", defaultValue: "https://images.pexels.com/photos/28610678/pexels-photo-28610678.jpeg?auto=compress&cs=tinysrgb&w=2400" },
      { key: "hero", label: "Hero", type: "pair", heading: ".hero h1", body: ".hero h1 + p" },
      { key: "execution_image", label: "Execution Section Image URL", type: "image", selector: "main .section-card:nth-of-type(1) .media-slab img", defaultValue: "https://images.pexels.com/photos/1271619/pexels-photo-1271619.jpeg?auto=compress&cs=tinysrgb&w=1800" },
    ...
    "team.html": [
      { key: "hero_image", label: "Hero Background Image URL", type: "css-image", variable: "--hero-team-image", defaultValue: "https://images.pexels.com/photos/208745/pexels-photo-208745.jpeg?auto=compress&cs=tinysrgb&w=2400" },
      { key: "hero", label: "Hero", type: "pair", heading: ".hero h1", body: ".hero h1 + p" },
    ...
    "contact.html": [
      { key: "hero_image", label: "Hero Background Image URL", type: "css-image", variable: "--hero-contact-image", defaultValue: "./assets/contact-hero-sf.png" },
      { key: "hero", label: "Hero", type: "pair", heading: ".hero h1", body: ".hero h1 + p" },
  ...
  function forceReplaceLegacyWomanPhotoEverywhere() {
        ...
        Object.keys(parsed).forEach((page) => {
          ...
          Object.keys(pageData).forEach((field) => {
            ...
            if (typeof value === "string" && HOME_IMAGE_REPLACEMENTS[value]) {
              ...
              pageData[field] = HOME_IMAGE_REPLACEMENTS["https://images.pexels.com/photos/4386467/pexels-photo-4386467.jpeg?auto=compress&cs=tinysrgb&w=1600"];
            }
          });
        });
    ...
    document.querySelectorAll("img").forEach((img) => {
      ...
      if (img.src.includes("pexels-photo-4386467")) {
        img.src = HOME_IMAGE_REPLACEMENTS["https://images.pexels.com/photos/4386467/pexels-photo-4386467.jpeg?auto=compress&cs=tinysrgb&w=1600"];
      }
    });
  }
