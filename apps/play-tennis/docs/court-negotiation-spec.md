...
What Rally actually coordinates is a smaller, tractable problem: **once two players have confirmed a time, who is responsible for making sure there is a court to play on?** For walk-on courts that means "who arrives first / grabs the court." For the handful of reservable courts it means "who clicks the reservation link (and, for paid venues, pays)." We call that person the **captain**.
