...
import { sendOtp, verifyOtp, savePlayerProfile, signInWithGoogle, signInWithApple, isTestEmail, getClient } from '../supabase'
      ...
      <div className="b-page">
        ...
        <div className="b-page-content">
          <div className="b-page-title-block">
            <h1 className="b-page-title">Join <em className="bg-em">Rally.</em></h1>
            <p className="b-page-subtitle">Find local opponents. Let us handle the scheduling.</p>
          </div>
          ...
          <button
            ...
            onClick={async () => {
              ...
              if (!result.ok) {
                setOtpError(
                  result.error === 'ios_google_client_id_missing'
                    ? "Google sign-in isn't configured in this build. Try email below, or use Apple."
                    : result.error || "Couldn't start Google sign-in. Try email below.",
                )
              }
            }}
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}
          >
            ...
            {isNative ? 'Continue with Google' : 'Sign up with Google'}
          </button>
          ...
          <form onSubmit={handleSendOtp}>
            <div className="b-field">
              <label className="b-field-label" htmlFor="signup-email">Email address</label>
              <input
                id="signup-email"
                className="b-input"
                type="email"
            ...
            {otpError && (
              <p className="b-helper" style={{ color: 'var(--danger)' }}>{otpError}</p>
            )}
          ...
          <p className="b-helper">No password. No spam. We only email you about matches.</p>
          ...
          <p className="b-switch">
            Already on Rally? <a href="/login">Log in</a>
          </p>
        </div>
      </div>
    )
  ...
  if (step === 'verify') {
    async function handleVerifyOtp(e: React.FormEvent) {
      ...
      if (result.ok && result.userId) {
        ...
        setOtpError("That code didn't work. Try again or resend.")
        setOtpCode('')
      }
    }
    ...
    async function handleResend() {
      ...
      if (result.ok) {
        ...
        setOtpError("Couldn't resend. Wait a moment and try again.")
      }
    }
      ...
      <div className="onboard-screen signup-screen">
        <div className="signup-content">
          <div className="signup-header">
            <h1 className="signup-title">A few quick details.</h1>
            <p className="signup-desc">So we can match you with players nearby.</p>
          </div>

          {inviteCounty && (
            <div className="signup-invite-banner">
              You're invited to play in {inviteCounty}.
            </div>
          )}
          ...
          <form onSubmit={handleSignup} className="signup-form">
            ...
            <div className="field" ref={suggestionsRef}>
              ...
              <span className="field-hint">We match you with players in your county.</span>
            </div>
          ...
          {county && (
            <p className="signup-social-proof">
              {getPlayerCount(county)} players already on Rally in {county.split(',')[0]}.
            </p>
          )}
        </div>
      </div>
      ...
      <div className="onboard-screen signup-screen">
        <div className="signup-content">
          <div className="signup-header">
            ...
            <p className="signup-desc">So we pair you with the right players.</p>
          </div>
          ...
          <div className="skill-gender-form">
            <div className="field">
              ...
              <p className="skill-reassurance">
                Not sure? Pick what feels closest. Your rating adjusts after a few matches.
              </p>
            </div>
    ...
    return (
      <div className="onboard-screen">
        <div className="onboard-content confirmed-content">
          ...
          <p className="onboard-subtitle">Picking up where you left off.</p>
      ...
      <div className="signup-content">
        ...
        <div className="avail-header">
          ...
          <p className="avail-value-prop">
            Pick your times. <span className="avail-value-highlight">We do the scheduling.</span>
          </p>
        </div>
