...
export default function Login({ onSignUp }: Props) {
  ...
  return (
    <div className="login-page" style={{ background: '#FAF5ED' }}>
      <div className="login-layout">
        {/* Form side */}
        <div className="login-form-side" style={{ background: '#FAF5ED' }}>
          <div className="login-form-wrapper">
            <div className="login-logo">
              <span style={{ fontFamily: "'Playfair Display', 'DM Serif Display', Georgia, serif", fontSize: 36, fontWeight: 700, color: '#1B2B4B', letterSpacing: '-0.01em' }}>rally.</span>
            </div>

            <h1 className="login-title" style={{ fontFamily: "'Playfair Display', 'DM Serif Display', Georgia, serif", color: '#1B2B4B' }}>Log In</h1>
            <p className="login-subtitle" style={{ color: '#4A5568' }}>Welcome back to Rally.</p>
            ...
            {step === 'email' ? (
              <form onSubmit={handleSendOtp} className="signup-form">
                ...
                <button
                  type="submit"
                  className="btn btn-primary btn-large signup-cta auth-cta" style={{ borderRadius: 999, background: '#1B2B4B', border: 'none' }}
