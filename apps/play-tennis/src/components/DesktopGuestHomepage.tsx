        ...
        <div className="sh-hero-inner">
          <div className="sh-hero-content">
            ...
            <div className="sh-hero-ctas">
              <button className="sh-btn-cta sh-btn-cta-large" onClick={onGetStarted}>Sign Up</button>
              <button className="sh-btn-signup sh-btn-email" onClick={handleLogin}>Log In</button>
            </div>
