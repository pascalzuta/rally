...
const ORIGINALS_DIR = path.resolve(PROJECT_ROOT, 'apps/grp/assets/originals');
const OUTPUT_DIR = path.resolve(PROJECT_ROOT, 'apps/grp/assets/optimized');
const MANIFEST_PATH = path.resolve(PROJECT_ROOT, 'apps/grp/assets/manifest.json');
